            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* Efecto de luz animado continuo */}
                  <motion.div
                    className="position-absolute top-0 start-0 w-100 h-100"
                    style={{
                  ...
                  >
                    ...
                    <div className="card-body p-4 d-flex align-items-center position-relative">
                      ...
                      {/* Botón eliminar */}
                        ...
                        whileHover={{ 
                            scale: 1.2, // Aumenté ligeramente el scale en hover
                            color: '#dc3545'
                        }}
                        whileTap={{ scale: 0.9 }}
                        style={{ 
                            ...
                            fontSize: '1.2rem' // Añadí tamaño de fuente para el icono
                        }}
                        >
                        <FaTrash size={20} /> {/* Aumenté el tamaño del icono a 20px */}
                        {/* Efecto de luz roja al hacer hover */}
                        <motion.div
                            className="position-absolute top-0 start-0 w-100 h-100"
                            style={{
                            ...
                            whileHover={{ 
                            opacity: 1,
                            scale: 1.1 // Efecto de luz más pronunciado
                            }}
                        />
                        </motion.button>
                    </div>
